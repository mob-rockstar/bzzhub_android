...
public class BusinesscategoryAdapter extends RecyclerView.Adapter<BusinesscategoryAdapter.Item>  {

    private Context mContext;
    private List<BusinessCategoryResponse.Result> categories;
    private SelectedListener mSelectedListener;

    public BusinesscategoryAdapter(Context mContext, List<BusinessCategoryResponse.Result> categories, SelectedListener mSelectedListener) {
    ...
    public void onBindViewHolder(@NonNull Item viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(view -> mSelectedListener.onSelected(position));
    }
