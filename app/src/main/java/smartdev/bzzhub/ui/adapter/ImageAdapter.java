...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.Item>{

    private Context mContext;
    private List<CompanyMediaResponse.Video> mImageList;
    private SelectedListener mSelectedListener;

    public ImageAdapter(Context mContext, List<CompanyMediaResponse.Video> mImageList,SelectedListener selectedListener) {
