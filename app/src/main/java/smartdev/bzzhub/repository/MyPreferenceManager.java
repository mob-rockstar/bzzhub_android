...
public class MyPreferenceManager {
    ...
    private static final String SETTINGS_NAME = "bzhub_preference";
    private static MyPreferenceManager sSharedPrefs;
    ...
    public static MyPreferenceManager getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new MyPreferenceManager(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
